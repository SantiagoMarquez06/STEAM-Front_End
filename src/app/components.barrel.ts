...
export { AdminEntityComponent } from './Administracion/admin-entity/admin-entity.component';
export { ReportesComponent } from './Reportes/reportes.component';
export { CargarInformacionComponent } from './CargarInformacion/cargar-informacion.component';
